...
Para baixar o arquivo:   (`https://www.dropbox.com/s/743zhimn68jea00/exemplo6_4.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados6_4 = read.csv("https://www.dropbox.com/s/743zhimn68jea00/exemplo6_4.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Para baixar o arquivo:   (`https://www.dropbox.com/s/r3ipoaysx8iy2pu/exemplo6_7.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados6_7 = read.csv("https://www.dropbox.com/s/r3ipoaysx8iy2pu/exemplo6_7.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Para baixar o arquivo:   (`https://www.dropbox.com/s/agzg7vf0jsih4rj/exemplo7_2.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados7_2 = read.csv("https://www.dropbox.com/s/agzg7vf0jsih4rj/exemplo7_2.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Para baixar o arquivo:   (`https://www.dropbox.com/s/xinp5up8xuhs3ic/exemplo8_2.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados8_2 = read.csv("https://www.dropbox.com/s/xinp5up8xuhs3ic/exemplo8_2.csv?dl=1", header = TRUE, sep = ";", dec = ".")
