...
`setwd("D:/Rproject/exemplos_livro/Agroestat")`  
Em seguida executar o comando para carregar os dados.
`dados4_6_2 = read.csv("exemplo4_6_2", header = TRUE, sep = ";", dec = ".")`  

Como opção, pode baixar o arquivo:   (`https://www.dropbox.com/s/biscf8tbms7981e/exemplo4_6_2.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados4_6_2 = read.csv("https://www.dropbox.com/s/biscf8tbms7981e/exemplo4_6_2.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Caso deseje baixar o arquivo:   (`https://www.dropbox.com/s/d47ywhef55g0zqz/exemplo5_5.csv?dl=0`)  

Carregar os dados a partir do link.
```{r}
dados5_5 = read.csv("https://www.dropbox.com/s/d47ywhef55g0zqz/exemplo5_5.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Caso deseje baixar o arquivo: (https://www.dropbox.com/s/gny73d4jcnawjm0/exemplo5_6_8.csv?dl=0) 

Carregar os dados a partir do link.
```{r}
dados5_6_8 = read.csv("https://www.dropbox.com/s/gny73d4jcnawjm0/exemplo5_6_8.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Caso deseje baixar o arquivo: (https://www.dropbox.com/s/wumc9jztynolpiw/exemplo5_8_6.csv?dl=0) 

Carregar os dados a partir do link.
```{r}
dados5_8_6 = read.csv("https://www.dropbox.com/s/wumc9jztynolpiw/exemplo5_8_6.csv?dl=1", header = TRUE, sep = ";", dec = ".")
...
Caso deseje baixar o arquivo: (https://www.dropbox.com/s/75msll06js7h3qc/exemplo5_9_2.csv?dl=0) 

Carregar os dados a partir do link.
```{r}
dados5_9_2 = read.csv("https://www.dropbox.com/s/75msll06js7h3qc/exemplo5_9_2.csv?dl=1", header = TRUE, sep = ";", dec = ".")
